...
public class MyPage extends JFrame {
	...
	public MyPage(User user) {
		...
		myInfo.setText("<html>" + str1 + "<br>" + str2 + "<p>" + str3 + "<p>" + str4 + "<p>" + str5 + "<p>" + str6
				+ "<p>" + str7 + "</html>"); // 텍스트 줄바꿈
		 ...
		 * method stub String buttonName = e.getActionCommand();
		 * 
		 * if (buttonName.equals("회원정보 수정")) { ModifyMyInfo m = new ModifyMyInfo();
		 * m.run(); setVisible(false); } else if (buttonName.equals("돌아가기")) { Table t =
