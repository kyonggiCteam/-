...
public class Ticket implements Manageable {
	...
	public String[] getTexts() {
		if (hour == 0)
			return new String[] {brandName, "자전거/킥보드", ticketType, price+"원", month+"개월"};
		else if (month == 0)
			return new String[] {brandName, "자전거/킥보드", ticketType, price+"원", hour+"시간"};
		else
			return new String[] {brandName, "자전거/킥보드", ticketType, price+"원", month+"개월 "+hour+"시간"};
	}
