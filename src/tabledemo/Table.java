...
public class Table extends JFrame{
	...
	public Table(ArrayList<User> userList, User user) {
		...
		String b = "현재 대여중인 기구의 코드는 " + user.vehicle.code + " 입니다.";
		...
		*/
		...
		btn_rpt.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {//고장신고
				// TODO Auto-generated method stub
